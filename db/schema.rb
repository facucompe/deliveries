...
ActiveRecord::Schema.define(version: 2021_05_08_185004) do
  ...
  create_table "deliveries", force: :cascade do |t|
    ...
    t.index ["tracking_number", "carrier"], name: "index_deliveries_on_tracking_number_and_carrier", unique: true
  end
